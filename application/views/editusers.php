...
<div id="container">
	...
	<a href="<?php echo site_url('welcome')?>">View User</a>
		...
		<form action="<?php echo base_url('welcome/editUserProcess'.'/'.$u['_id'])?>" method="post">
		<table style="margin:20px auto;">
			...
			<tr>
				<td>Unique Id</td>
				<td><input type="text" name="unik" value="<?php echo $u['unik']?>"></td>
				<input type="hidden" name="id" value="<?php echo $u['_id']?>">
			</tr>
			<tr>
